...
public class EzUserCreationDefaults {
	...
	private  List<EzStates> STATES = null;
	private  List<EzStateHead> STATE_HEAD = null;
	private  List<String> CATEGORIES = null;
	// private static final List<EzZonalHead> ZONAL_HEAD = new
	// ArrayList<EzZonalHead>();
	private  List<UserRoles> ROLES = null;
	private  List<UserZones> ZONES = null;
	...
	public void initData() {
		STATES = new ArrayList<EzStates>();
		STATE_HEAD = new ArrayList<EzStateHead>();
		CATEGORIES = new ArrayList<String>();
		// private static final List<EzZonalHead> ZONAL_HEAD = new
		// ArrayList<EzZonalHead>();
		ROLES = new ArrayList<UserRoles>();
		ZONES = new ArrayList<UserZones>();
		...
		List<Work_Groups> stateList=groupRepository.findByRole("ROLE_REQ_CR");
    	if(stateList != null) 
    	{
    		for(Work_Groups workGrp:stateList)
    		{
    			STATES.add(new EzStates(workGrp.getName(), workGrp.getDesc(),"REQ_CR"));
    		}
    	}
    	CATEGORIES.add("PLUMBING");
    	CATEGORIES.add("COLUMN");
    	CATEGORIES.add("WATERTANK");
...
//    	STATES.add(new EzStates("IN", "India","REQ_CR"));
		 ...
		 * ZONAL_HEAD.add(new EzZonalHead("NORTH_ZONE_GRP",
		 * "Head North Zone","ZN_HEAD")); ZONAL_HEAD.add(new
		 * EzZonalHead("SOUTH_ZONE_GRP", "Head South Zone","ZN_HEAD"));
		 */

		List<Work_Groups> zoneList=groupRepository.findByRole("ROLE_ZN_HEAD");
    	if(zoneList != null) 
    	{
    		for(Work_Groups workGrp:zoneList)
    		{
    			ZONES.add(new UserZones(workGrp.getName(), workGrp.getDesc()));
    		}
    	}
		
		/*
		 * ZONES.add(new UserZones("EAST", "East Zone")); ZONES.add(new
		 * UserZones("WEST", "West Zone")); ZONES.add(new UserZones("NORTH",
		 * "North Zone")); ZONES.add(new UserZones("SOUTH", "South Zone"));
	...
	/*
	 * public List<EzZonalHead> getZN_HDGroups() { return ZONAL_HEAD; }
	 */
